...
use Mail;
use Carbon\Carbon;
use App\Mail\MailUpdateotom;
use Illuminate\Support\Facades\Log;


class PifupdateController extends Controller
{
    public function update_oracle_to_mysql(){
        ...
        // return response()->json(['status' => $status ,'count_fg' => $count_fg ,'count_master' => $count_master ,'count_retail_inner' => $count_retail_inner ,'count_log' => $count_log]);
