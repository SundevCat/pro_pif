    ...
    <div class=" container-fluid ">
        <div class="card w-50 m-auto">
            <div class="card-header bg-primary">
                <div class=" text-center text-white"> edit user </div>
            </div>
            <div class="card-body m-2">
                @foreach ($data as $user)
                    <form action="{{ URL::to('users/updateuser') }}" method="POST">
                        @csrf
                        <div class="col">
                        ...
                        <div class="col">
                            <div class=" form-group">
                                ...
                                <select class="custom-select custom-select-sm" name="is_admin" id="is_admin">
                                    @if ($user->is_admin == 1)
                        ...
                        {{-- <div class="col">
                            <div class="form-group">
                                ...
                                <input class=" form-control @error('password') form-control-danger  @enderror"
                                    style="border-radius:0.25rem " type="hidden" id="password" name="password">
                                @error('password')
